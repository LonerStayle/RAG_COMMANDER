...
class PromptType(Enum):
    ...
    LOCATION_INSIGHT_SYSTEM = (
        ...
        str(
            ...
            / "src"
            / "prompts"
            / "analysis_location_insight.yaml"
        ),
        "입지 분석 에이전트의 시스템 메시지",
    )
    ...
    SUPPLY_DEMAND_SYSTEM = (
        "SUPPLY_DEMAND_SYSTEM",
        str(
            Path(get_project_root()) / "src" / "prompts" / "analysis_supply_demend.yaml"
        ),
    ...
    NEARBY_MARKET_SYSTEM = (
        "NEARBY_MARKET_SYSTEM",
        str(
            Path(get_project_root()) / "src" / "prompts" / "analysis_nearby_market.yaml"
        ),
    ...
    POPULATION_INSIGHT_SYSTEM = (
        ...
        str(
            ...
            / "src"
            / "prompts"
            / "analysis_population_insight.yaml"
        ),
