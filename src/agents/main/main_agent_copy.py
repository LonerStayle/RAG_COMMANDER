...
def final_node(state: MainState) -> MainState:
    ...
    send_gmail(
        ...
        drive_links={
            ...
            "국토교통부 6.27 대책" :"https://www.molit.go.kr/USR/NEWS/m_71/dtl.jsp?lcmspage=1&id=95091036",
            "국토교통부 10.15 대책" : "https://www.molit.go.kr/USR/NEWS/m_71/dtl.jsp?lcmspage=1&id=95091308"
        },
    )
